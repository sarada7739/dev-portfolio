...
T-002 | V2 | 完了 | デザイントークン抽出 → docs/design-tokens.md と globals.css @theme
...
T-013 | L2 | 完了 | Cloudflare Pages 接続・環境変数設定・公開確認
...
T-022 | L1 | 完了 | リンク未指定の制作物カードはクリックで画像を拡大（ライトボックス）
T-023 | L0 | 完了 | カード button 化で中身が縦中央に寄る不具合（T-022 の回帰）
T-024 | L0 | 完了 | ホームページ運用代行サービスをグリッド3枚目に追加
T-025 | L0 | 完了 | ヒーローのサブ文言から「— 東京から、ていねいに。」を削除
